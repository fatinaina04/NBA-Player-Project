...
public class api2 {
    ...
    public static void main(String[] args) throws JSONException {
        try {
            ...
            FileWriter writer = new FileWriter("players1.csv");
    ...
    private static void getStats() throws JSONException {
        try {
            for (int i = 0; i < idCount; i++) {
                ...
                // Create URL object with the API endpoint and required parameters
    ...
    private static void appendDataToCSV(JSONArray data) throws IOException, JSONException {
        FileWriter writer = new FileWriter("players1.csv", true); // Append mode
        ...
        for (int i = 0; i < data.length(); i++) {
            ...
            writer.write(id + "," + firstName + "," + lastName + "," + position + "," + height + "," + weight);
    ...
    private static void appendStatsToCSV(int playerId, JSONObject stats) throws IOException, JSONException {
        FileReader fileReader = new FileReader("players1.csv");
